...
int main(){
    ...
    //Grafo da 3 Letra B
    int grafo[V][V] = {
        {0, 4, 1, 3, INF, INF, INF, INF, INF, INF},
        {INF, 0, 1, INF, 3, INF, INF, INF, INF, INF},
        {INF, INF, 0, 1, 7, 6, INF, INF, INF, INF},
        {INF, INF, INF, 0, INF, 2, 3, 2, INF, INF},
        {INF, INF, INF, INF, 0, 1, INF, INF, 2, INF},
        {INF, INF, INF, INF, INF, 0, INF, INF, 4, INF},
        {INF, INF, INF, INF, INF, INF, 0, 5, 4, INF},
...
//Função vai imprimir a disntacia do ponto A aos demais pontos da Matriz
void distancia_dos_pontos(int matriz[][V]){
